  ...
  <div class="navbar">
    <v-layout>
      ...
      >
        ...
        <v-spacer></v-spacer>
        <div class="phone" v-if="width >= 1000">
          <v-btn href="tel:88463754131">
            <svg
        ...
        <v-spacer></v-spacer>
        <div class="auth" v-if="width >= 1000">
          <v-btn class="text-none" color="#3D8BE4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
              height="30"
...
.d-flex {
  gap: 22.5px; // 45/2 idk why this scale
}
</style>
